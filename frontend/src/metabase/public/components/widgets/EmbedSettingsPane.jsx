...
const EmbedSettingsPane = ({ className, card, secure, onChangeSecure, parameters, onChangeParameters }) =>
    <div className={cx(className, "rounded bordered p2 flex flex-column bg-white")} style={{ width: 320 }}>
        <Section title="Security">
            <p>Require secure signing of this embed</p>
            <Toggle value={secure} onChange={onChangeSecure} />
        </Section>
        <Section title="Style">

            <div className="flex">
                <div className="flex-full flex layout-centered mx1 p1 border-bottom border-med">Light</div>
                <div className="flex-full flex layout-centered mx1 p1 border-bottom border-med">Dark</div>
                <div className="hide" />
            </div>
        </Section>
